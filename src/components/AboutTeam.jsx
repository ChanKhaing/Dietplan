...
const AboutTeam = () => {
  return (
    <div className="mt-44">
      <Container>
        <header>
          <h4 className=" text-center text-2xl font-dancing">Our team</h4>
          <h1 className="text-6xl my-4 font-roboto font-medium text-black text-center">
            Meet with us
          </h1>
          <h3 className=" text-center text-xl font-roboto">
        ...
        <section className="grid grid-cols-3 gap-5  ">
          <div className=" border w-[400px]  rounded-2xl h-[500px] mt-20 bg-gray-200  ">
            ...
            <h1 className="text-3xl font-roboto mt-6 font-semibold text-center text-black">
              David James
            </h1>
          ...
          <div className=" border w-[400px]  rounded-2xl h-[500px] mt-20 bg-gray-200  ">
            ...
            <h1 className="text-3xl font-roboto font-semibold mt-6 text-center text-black">
              Ella Wendy
            </h1>
            <h4 className=" text-center text-base my-2">Nutrition chef</h4>
            <AboutIcon/>
