      ...
      <Container>
        <section className="flex justify-between mb-10">
          ...
          <div className="grid grid-cols-2 gap-5">
            <button class=" inline-flex font-serif  text-center mx-auto items-center text-white bg-black mx-auto border-2 border-slate-800  px-8 py-2 duration-1000	 focus:outline-none rounded-xl text-lg">
              SIGNUP Now
            </button>
